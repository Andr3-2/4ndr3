...
int main(int argc, char** argv) {
    ...
    switch(cargo){
        ...
        case 'C':
            contasC(mes,VencimentoBase, SubsidioAlimentação, irs,total,SegurançaSocial,entidadePatronal);
        case 'A':
            contasA(mes,VencimentoBase, SubsidioAlimentação, irs,total,SegurançaSocial,entidadePatronal);
    }
